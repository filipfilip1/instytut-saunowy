...
export const metadata = {
  ...
  description: 'Skontaktuj się z nami. Email, telefon, WhatsApp, Messenger. Odpowiemy na wszystkie Twoje pytania o szkolenia Aufguss, produkty i współpracę.',
};
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <FadeIn className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-wood-100 max-w-3xl mx-auto leading-relaxed">
              Masz pytania? Chcesz poznać szczegóły naszej oferty?
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-wood-700 to-wood-900 text-white rounded-2xl p-8 shadow-xl">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1">Godziny dostępności</h4>
                        <p className="text-wood-100">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-wood-100">
                          Odpowiadamy w ciągu 24 godzin roboczych<br />
                          WhatsApp/Messenger: szybsza odpowiedź
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border-2 border-blue-200">
                  ...
                  <p className="text-gray-700 mb-4">
                    Sprawdź naszą bazę wiedzy - może znajdziesz odpowiedź na swoje pytanie!
                  </p>
                  <a
                    href="/akademia"
