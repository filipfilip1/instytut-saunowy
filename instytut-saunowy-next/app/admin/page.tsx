    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Panel Admina</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Zamówienia</h3>
            ...
            <p className="text-sm text-gray-600 mt-1">Aktywnych zamówień</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">0</p>
            <p className="text-sm text-gray-600 mt-1">W ofercie</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">0</p>
            <p className="text-sm text-gray-600 mt-1">Zarejestrowanych</p>
          </div>
        </div>
